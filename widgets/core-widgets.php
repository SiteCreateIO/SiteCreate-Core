<?php 
if(!( class_exists('sitecreate_core_popular_posts_widget') )){
	class sitecreate_core_popular_posts_widget extends WP_Widget {
		
		public function __construct(){
			parent::__construct(
				'sc_core_popular-widget', // Base ID
				__('SC: Popular Posts', 'sitecreate-core'), // Name
				array( 'description' => __( 'Add a simple popular posts widget', 'sitecreate-core' ), ) // Args
			);
		}
	...
	function sitecreate_core_register_popular_posts_widget(){
	     register_widget( 'sitecreate_core_popular_posts_widget' );
	}
	add_action( 'widgets_init', 'sitecreate_core_register_popular_posts_widget');
}


if(!( class_exists('sitecreate_core_latest_posts_widget') )){
	class sitecreate_core_latest_posts_widget extends WP_Widget {
		
		public function __construct(){
			parent::__construct(
				'sc_core_latest-widget', // Base ID
				__('SC: Latest Posts', 'sitecreate-core'), // Name
				array( 'description' => __( 'Add a simple lates posts widget', 'sitecreate-core' ), ) // Args
			);
		}
	...
	function sitecreate_core_register_latest_posts_widget(){
	     register_widget( 'sitecreate_core_latest_posts_widget' );
	}
	add_action( 'widgets_init', 'sitecreate_core_register_latest_posts_widget');
}


if(!( class_exists('sitecreate_core_latest_tweets_widget') )){
	class sitecreate_core_latest_tweets_widget extends WP_Widget {
		
		public function __construct(){
			parent::__construct(
				'sc_core_latest-tweets-widget', // Base ID
				__('SC: Latest Tweets', 'sitecreate-core'), // Name
				array( 'description' => __( 'Add a simple latest tweets widget', 'sitecreate-core' ), ) // Args
			);
		}
	...
	function sitecreate_core_register_latest_tweets_widget(){
	     register_widget( 'sitecreate_core_latest_tweets_widget' );
	}
...
/*	CONTACT WIDGET
/*-----------------------------------------------------------------------------------*/
if(!( class_exists('sitecreate_social_widget') )){
	class sitecreate_social_widget extends WP_Widget {
		
		public function __construct(){
			parent::__construct(
				'ebor_contact-widget', // Base ID
				__('SC: Social Icons', 'sitecreate-core'), // Name
				array( 'description' => __( 'Add a simple social icons widget', 'sitecreate-core' ), ) // Args
			);
		}
